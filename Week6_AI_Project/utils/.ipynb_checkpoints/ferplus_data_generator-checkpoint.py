...
from bounding_box_util import Rect
from image_utils import compute_norm_mat, distort_img, preproc_img
...
class FERPlusReader(object):
    ...
    def _process_data(self, emotion_raw, mode):
        ...
        Probability or Crossentropy: convert the count into probability distribution.abs
